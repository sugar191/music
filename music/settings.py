...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "sugar191.pythonanywhere.com"]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "rest_framework.authentication.SessionAuthentication",  # 既存管理画面等
        "rest_framework_simplejwt.authentication.JWTAuthentication",  # 外部クライアント
    ],
}
...
CORS_ALLOWED_ORIGINS = [
    "https://sugar191.pythonanywhere.com",
    "http://localhost:8000",
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
